select
	...
	smn_banco.smn_movimiento_bancario.mov_beneficiario_pago,
...
from
	...
	left outer join smn_banco.smn_movimiento_detalle on smn_banco.smn_movimiento_detalle.smn_movimiento_bancario_id = smn_banco.smn_movimiento_bancario.smn_movimiento_bancario_id
	...
	left outer join smn_banco.smn_concepto on smn_banco.smn_concepto.smn_concepto_id = smn_banco.smn_movimiento_detalle.smn_concepto_id
...
where 
	smn_banco.smn_movimiento_bancario.smn_movimiento_bancario_id is not null
	${filter}