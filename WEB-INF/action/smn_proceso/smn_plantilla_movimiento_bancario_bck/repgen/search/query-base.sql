...
from
	...
	inner join smn_base.smn_sucursales on smn_base.smn_sucursales.smn_sucursales_id = smn_banco.smn_plantilla_movimiento_bancario.smn_sucursal_rf
...
where
	smn_banco.smn_plantilla_movimiento_bancario.smn_plantilla_movimiento_bancario_id is not null
	${filter}