...
where
smn_relacion_cobranza_id=(select smn_cobranzas.smn_relacion_cobranza.smn_relacion_cobranza_id
FROM
...
AND smn_banco.smn_movimiento_bancario.mov_numero_documento = smn_caja.smn_deposito.dep_numero_deposito 
...
where smn_banco.smn_movimiento_bancario.smn_movimiento_bancario_id=${fld:mov_id}
);